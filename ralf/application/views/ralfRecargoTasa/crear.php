    ...
    <div class="zona zona-centro-trabajo">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <div class="field">                            
                            <?php echo Form::select("tipo_resolucion", $list_tipo_resolucion_informada, $default["tipo_resolucion"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "tipo_resolucion"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("nro_resolucion", $default["nro_resolucion"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "nro_resolucion"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("fecha_de_resolucion", $default["fecha_de_resolucion"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "fecha_de_resolucion"); ?></div>
                        </div>
                    </td>
                </tr>
                <tr class="label-row">
    ...
    <div class="zona zona-centro-trabajo">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <div class="field">                            
                            <?php echo Form::select("causal_de_recargo", $list_causal_de_recargo, $default["causal_de_recargo"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "causal_de_recargo"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                        <?php echo Form::select("proceso_asociado_al_recargo", $list_proceso_asociado_al_recargo, $default["proceso_asociado_al_recargo"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "proceso_asociado_al_recargo"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("otro_proceso_asociado_al_recargo", $default["otro_proceso_asociado_al_recargo"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "otro_proceso_asociado_al_recargo"); ?></div>
                        </div>
                    </td>
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("nro_trabajadores_entidad_empleadora_TT", $default["nro_trabajadores_entidad_empleadora_TT"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "nro_trabajadores_entidad_empleadora_TT"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("magnitud_de_incumplimiento_TA", $default["magnitud_de_incumplimiento_TA"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "magnitud_de_incumplimiento_TA"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::select("porcentaje_base_recargo", $list_porcentaje_base_recargo, $default["porcentaje_base_recargo"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "porcentaje_base_recargo"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("porcentaje_del_recargo", $default["porcentaje_del_recargo"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "porcentaje_del_recargo"); ?></div>
                        </div>
                    </td>
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("tasa_adicional_110", $default["tasa_adicional_110"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "tasa_adicional_110"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("recargo_resultante", $default["recargo_resultante"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "recargo_resultante"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("tasa_cot_adicional", $default["tasa_cot_adicional"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "tasa_cot_adicional"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("tasa_adicional_con_recargo", $default["tasa_adicional_con_recargo"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "tasa_adicional_con_recargo"); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="field">                            
                            <?php echo Form::input("fecha_vigencia", $default["fecha_vigencia"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "fecha_vigencia"); ?></div>
                        </div>
                    </td>
                </tr>
                <tr class="label-row">
