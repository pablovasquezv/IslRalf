    ...
    <div class="zona-accidente">
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        ...
                        <div class="field">                
                            <?php echo Form::input("fecha_informe_acciones_adoptadas",$default["fecha_informe_acciones_adoptadas"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "fecha_informe_acciones_adoptadas"); ?></div>
                        </div>
                    </td></tr>
                <tr class="label-row"><th>Fecha del informe de acciones adoptadas</th></tr>
            </tbody></table>
            <h3>Medidas no implementadas</h3>
            <table>
            <tbody><tr class="data-row"><td>                        
                        <div class="field">                
                            <?php echo Form::input("medidas_no_implementadas_fecha_verificacion",$default["medidas_no_implementadas_fecha_verificacion"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "medidas_no_implementadas_fecha_verificacion"); ?></div>
                        </div>
                    </td></tr>
            ...
            <h3>Medidas</h3>
            <?php echo HTML::anchor("medidas/medidas_no_implementadas/{$xml_id}",'Agregar Medidas no implementadas ',array('class'=>'fancybox-narrow'))?>    
                ...
                <tbody>                    
                    <?php foreach ($medidas as $m):?>    
                        <tr class="data-row">                            
                            ...
                            <td><?php if($documento->ESTADO == 5): ?><?php echo HTML::anchor("ralf5/borrar_medida/{$m->id}",'borrar',array('class'=>'fancybox-small'))?> <?php endif; ?></td>
                        </tr>                    
                    <?php endforeach;?>
                </tbody></table>
                <br />
                <br />
            <h3>Medidas no implementadas que tuvieron ampliación de plazo</h3>            
            <table>
            <tbody><tr class="data-row"><td>                        
                        <div class="field">                
                            <?php echo Form::input("medidas_no_implementadas_plazo_ampliado_fecha_verificacion",$default["medidas_no_implementadas_plazo_ampliado_fecha_verificacion"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "medidas_no_implementadas_plazo_ampliado_fecha_verificacion"); ?></div>
                        </div>
                    </td></tr>
                <tr class="label-row"><th>Fecha verificacion</th></tr>
            </tbody></table>
            <h3>Medidas</h3>
            <?php echo HTML::anchor("medidas/medidas_no_implementadas_plazo_ampliado/{$xml_id}",'Agregar Medidas no implementadas que tuvieron ampliación de plazo ',array('class'=>'fancybox-narrow'))?>    
            ...
            <table id="medida2">
                ...
                <tbody>                    
                    <?php foreach ($medidas as $m):?>    
                        <tr class="data-row">                            
                            <td><?php echo $m->medida?></td>                            
                            <td><?php if($documento->ESTADO == 5): ?><?php echo HTML::anchor("ralf5/borrar_medida2/{$m->id}",'borrar',array('class'=>'fancybox-small'))?> <?php endif; ?></td>
                        </tr>                    
                    <?php endforeach;?>
                </tbody></table>
                <br />
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        ...
                        <div class="field">                
                            <?php echo Form::select("aplicacion_multa_art_80_ley",$si_no,$default["aplicacion_multa_art_80_ley"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "aplicacion_multa_art_80_ley"); ?></div>
                        </div>
                    </td></tr>
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        <?php //echo $si_no[(string)$xml->ZONA_T->acciones_adoptadas->monto_multa];?>
                        <div class="field">                
                            <?php echo Form::input("monto_multa",$default["monto_multa"]); ?>
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        <?php //echo $si_no[(string)$xml->ZONA_T->acciones_adoptadas->fecha_multa];?>
                        <div class="field">                
                            <?php echo Form::input("fecha_multa",$default["fecha_multa"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "fecha_multa"); ?></div>
                        </div>
                    </td></tr>
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        ...
                        <div class="field">                
                            <?php echo Form::select("recargo_ds67_a15",$si_no,$default["recargo_ds67_a15"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "recargo_ds67_a15"); ?></div>
                        </div>
                    </td></tr>
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        ...
                        <div class="field">                
                            <?php echo Form::select("recargo_ds67_a5",$si_no_nc,$default["recargo_ds67_a5"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "recargo_ds67_a5"); ?></div>
                        </div>
                    </td></tr>
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        ...
                        <div class="field">                
                            <?php echo Form::input("fecha_inicio_recargo_a15",$default["fecha_inicio_recargo_a15"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "fecha_inicio_recargo_a15"); ?></div>
                        </div>
                    </td></tr>
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        ...
                        <div class="field">                
                            <?php echo Form::input("fecha_termino_recargo_a15",$default["fecha_termino_recargo_a15"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "fecha_termino_recargo_a15"); ?></div>
                        </div>
                    </td></tr>
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        ...
                        <div class="field">                
                            <?php echo Form::select("comunicacion_dir_trabajo",$si_no,$default["comunicacion_dir_trabajo"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "comunicacion_dir_trabajo"); ?></div>
                        </div>                    
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        ...
                        <div class="field">                
                            <?php echo Form::input("nro_comunic_dir_trabajo", $default["nro_comunic_dir_trabajo"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "nro_comunic_dir_trabajo"); ?></div>
                        </div>
                    </td>                    
                </tr>
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        ...
                        <div class="field">                
                            <?php echo Form::input("fecha_comunic_dir_trabajo", $default["fecha_comunic_dir_trabajo"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "fecha_comunic_dir_trabajo"); ?></div>
                        </div>
                    </td>                    
                </tr>
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        ...
                        <div class="field">                
                            <?php echo Form::select("comunicacion_seremi", $si_no,$default["comunicacion_seremi"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "comunicacion_seremi"); ?></div>
                        </div>
                    </td></tr>
        ...
        <table>
            <tbody><tr class="data-row">                    
                    <td>
                        <?php //echo $xml->ZONA_T->acciones_adoptadas->identificacion_seremi;?>
                        <div class="field">                
                            <?php echo Form::select("identificacion_seremi",$STNumSEREMI, $default["identificacion_seremi"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "identificacion_seremi"); ?></div>
                        </div>
                    </td>                    
                </tr>
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        ...
                        <div class="field">                
                            <?php echo Form::input("nro_comunic_seremi", $default["nro_comunic_seremi"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "nro_comunic_seremi"); ?></div>
                        </div>
                    </td>                    
                </tr>
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        ...
                        <div class="field">                
                            <?php echo Form::input("fecha_comunic_seremi", $default["fecha_comunic_seremi"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "fecha_comunic_seremi"); ?></div>
                        </div>
                    </td>                    
                </tr>
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        ...
                        <div class="field">                
                            <?php echo Form::select("plan_esp_trabajo_empresa", $si_no,$default["plan_esp_trabajo_empresa"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "plan_esp_trabajo_empresa"); ?></div>
                        </div>
                    </td>                    
                </tr>
            ...
            <tbody><tr class="data-row">
                    <td>
                        ...
                        <div class="field">                
                            <?php echo Form::input("fecha_ini_plan_trabajo_empresa", $default["fecha_ini_plan_trabajo_empresa"],array('class'=>'datepicker')); ?>
                            <div class="error"><?php echo Arr::get($errors, "fecha_ini_plan_trabajo_empresa"); ?></div>
                        </div>
                    </td>                    
                </tr>
            ...
            <tbody><tr class="data-row"><td>
                ...
                <div class="field">                
                    <?php echo Form::textarea("resumen_plan_trabajo", $default["resumen_plan_trabajo"]); ?>
                    <div class="error"><?php echo Arr::get($errors, "resumen_plan_trabajo"); ?></div>
                </div>
            </td></tr>
                <tr class="label-row"><th>Resumen del plan de trabajo con la empresa</th></tr>
            </tbody></table>
        <h4>Documentos Anexos</h4>
        <?php echo HTML::anchor("adjuntos/documento_anexo_ralf5/{$xml_id}",'Agregar Anexos ',array('class'=>'fancybox-narrow'))?>    
        <?php $anexos=ORM::factory('Adjunto')->where('xml_id','=',$xml_id)->where('origen','=','documentos_anexos_ralf5')->find_all();?>
        <div class="error"><?php echo Arr::get($errors, "documentos_anexos_ralf5"); ?></div> 
        <table id="adjuntos">
            <thead>
            	<tr class="label-row">                    
                ...
                <?php foreach ($anexos as $anexo):?>    
                    <tr class="data-row">                    	
                        ...
                        <td>
                            ...
                            <?php if($documento->ESTADO == 5): ?> | <?php echo HTML::anchor("ralf5/borrar_adjunto/{$anexo->id}",'borrar',array('class'=>'fancybox-small'))?> <?php endif; ?>
                        </td>                        
                    </tr>                
                <?php endforeach;?>
            </tbody></table>
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>                        
                        <?php //echo $xml->ZONA_T->acciones_adoptadas->representante_oa->apellido_nombres;?>
                        <div class="field">                
                            <?php echo Form::input("representante_oa_nombres", $default["representante_oa_nombres"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "representante_oa_nombres"); ?></div>
                        </div>
                    </td><td>                        
                        <?php //echo $xml->ZONA_T->acciones_adoptadas->representante_oa->apellido_paterno;?>
                        <div class="field">                
                            <?php echo Form::input("representante_oa_apellido_paterno", $default["representante_oa_apellido_paterno"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "representante_oa_apellido_paterno"); ?></div>
                        </div>
                    </td><td>                          
                        <?php //echo $xml->ZONA_T->acciones_adoptadas->representante_oa->apellido_materno;?>
                        <div class="field">                
                            <?php echo Form::input("representante_oa_apellido_materno", $default["representante_oa_apellido_materno"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "representante_oa_apellido_materno"); ?></div>
                        </div>
                    </td><td>
                        <?php //echo $xml->ZONA_T->acciones_adoptadas->representante_oa->rut;?>
                        <div class="field">                
                            <?php echo Form::input("representante_oa_rut", $default["representante_oa_rut"]); ?>
                            <div class="error"><?php echo Arr::get($errors, "representante_oa_rut"); ?></div>
                        </div>                        
                    </td>                    
                </tr>
                <tr class="label-row">
