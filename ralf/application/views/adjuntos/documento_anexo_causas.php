...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var w = document.defaultView || document.parentWindow;
  		...
  		var l = d.getElementById('adjuntos_causas');
  		<?php if(isset($_POST)):?>
		$(l).find('tbody').remove();
		...
		function get_adjuntos(){
			$t = $("<tbody></tbody>");
			$.get('<?php echo URL::site("adjuntos/adjuntos_documento_anexo_causas/$xml_id");?>', function(data) {
...
<!--
<h2 class="tit-bandeja"><?php echo __('Documento Anexo'); ?></h2>
<?php if($mensaje_error):?>          
	<div class="error"><h3><?php echo $mensaje_error; ?></h3></div>      
<?php endif; ?>
<?php echo Form::open(NULL, array('enctype' => 'multipart/form-data'))?>
<table class="tabla-general">	
    ...
    <tr>
		<td><?php echo __('Seleccione archivo')?></td>
		<td>
			<?php echo Form::file('antecedente')?>
            <div class="error"><?php echo  Arr::get($errors, 'antecedente'); ?></div>
		</td>
    ...
    <tr>
		<td colspan="2"><?php echo Form::submit('boton_subir_documento', 'Subir')?></td>
    </tr>
</table>     -->                                           
<?php echo Form::close()?>