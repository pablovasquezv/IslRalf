...
<div id="denuncia-electronica">
    <h2><?php echo __('(RALF) Notificación provisoria inmediata accidente laboral fatal'); ?></h2>
    ...
    <?php endif; ?>
    <?php echo Form::open(); ?>
    <?php echo View::factory('ralf/zona/zona_a', $data)->render(); ?>
    <?php echo View::factory('ralf/zona/zona_b', $data)->set('errors',$errors)->set('default',$default)->render(); ?>
    <?php echo View::factory('ralf/zona/crear/zona_b_complemento', $data)->set('errors',$errors)->set('default',$default)->render(); ?>
    <?php echo View::factory('ralf/zona/zona_c', $data)->set('errors',$errors)->set('default',$default)->render(); ?>
    <?php echo View::factory('ralf/zona/crear/zona_p')->set('errors',$errors)->set('default',$default)->set('data',$data)->render(); ?>
</div>
