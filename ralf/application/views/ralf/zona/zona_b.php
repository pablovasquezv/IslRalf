    ...
    <div class='form_section employer'>
        ...
        <div class='row'><!--<div class='address'>-->
            ...
            <div class='field codigo_comuna'>
                ...
                <div class='protected_field codigo_comuna'><?php echo form::select('comuna_empleador', Model_St_Comuna::obtener(), $default['comuna_empleador'], array('class' => 'comuna_select')); ?></div>
                <div class="error"><?php echo Arr::get($errors, 'comuna_empleador'); ?></div>
        ...
        <div class='row'>
            <div class='field ciiu'>
                ...
                <div class='protected_field ciiu'><?php echo form::select('ciiu_empleador', Model_St_Ciiu::obtener(), $default['ciiu_empleador'], array('class' => 'select_ciiu')); ?></div>
                <div class="error"><?php echo Arr::get($errors, 'ciiu_empleador'); ?></div>
            </div>
            ...
            <div class='field ciiu_secundario'>
                ...
                <div class='protected_field ciiu_secundario'><?php echo form::select('ciiu2_empleador', Model_St_Ciiu::obtener(), $default['ciiu2_empleador'], array('class' => 'select_ciiu')); ?></div>
                <div class="error"><?php echo Arr::get($errors, 'ciiu2_empleador'); ?></div>
            </div>
