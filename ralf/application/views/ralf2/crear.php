<div id="denuncia-electronica">    
    ...
    <?php endif; ?>    
    <?php echo Form::open(); ?>
    <?php echo View::factory('ralf2/zona/zona_a', $data)->render(); ?>
    <?php echo View::factory('ralf2/zona/zona_b', $data)->render(); ?>
    <?php echo View::factory('ralf2/zona/zona_b_complemento', $data)->render(); ?>    
    <?php echo View::factory('ralf2/zona/zona_c', $data)->render(); ?>   
    <?php echo View::factory('ralf2/zona/zona_p', $data)->render(); ?>   
    <?php echo View::factory('ralf2/zona/crear/zona_q', $data)->set('errors',$errors)->set('default',$default)->set('xml_id',$xml_id)->set('documento', $documento)->render(); ?>     
</div>
