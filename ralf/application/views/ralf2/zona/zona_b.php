<?php
  if(isset($xml->ZONA_B->empleador->ciiu_empleador) && !empty($xml->ZONA_B->empleador->ciiu_empleador)){
    $ciiu1 = (string)$xml->ZONA_B->empleador->ciiu_empleador;
    $ciiu1_empleador = $ciius[$ciiu1] ? : $ciiu1 .' (CIIU Obsoleto)';
  }else {
    $ciiu1_empleador='n/a';
  }

  if(isset($xml->ZONA_B->empleador->ciiu2_empleador) && !empty($xml->ZONA_B->empleador->ciiu2_empleador)) {
    $ciiu2 = (string)$xml->ZONA_B->empleador->ciiu2_empleador;
    $ciiu2_empleador = $ciius[$ciiu2] ? : $ciiu2 .' (CIIU Obsoleto)';
  }else {
    $ciiu2_empleador='n/a';
  }
?>
    ...
    <div class='row'>
      <!--<div class='address'>-->
        <div class='field codigo_tipo_calle'>
          ...
          <div class='protected_field codigo_tipo_calle'><?php echo $tipo_calle[(string)$xml->ZONA_B->empleador->direccion_empleador->tipo_calle]; ?></div>
        </div>
        ...
        <div class='field codigo_comuna'>
          ...
          <div class='protected_field codigo_comuna'><?php echo $comunas[(string)$xml->ZONA_B->empleador->direccion_empleador->comuna];?></div>
        </div>
      <!--</div>
      <div class='telephone'>-->
