...
<div class='form_section_container'>
    <div class='form_section accident'>                
        <div class="row">
            ...
            <div class="field nro_sucursales"><label for="complaint_diat_attributes_employee_attributes_rut">Nº sucursales</label><br>
            <div class='protected_field nro_sucursales'><?php echo $xml->ZONA_B->empleador->nro_sucursales; ?></div>                                
            </div>
            <div class="clear"></div>            
            <div class="field tasa_ds110"><label for="complaint_diat_attributes_employee_attributes_apellido_paterno">Tasa ds110</label><br>
            <div class='protected_field tasa_ds110'><?php echo $xml->ZONA_B->empleador->tasa_ds110; ?></div>                
            </div>       
            <div class="field tasa_ds67"><label for="complaint_diat_attributes_employee_attributes_apellido_materno">Tasa ds67</label><br>
            <div class='protected_field tasa_ds67'><?php echo $xml->ZONA_B->empleador->tasa_ds67; ?></div>                
            </div>  
            <div class="field ultima_eval_ds67">
