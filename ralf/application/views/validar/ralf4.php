    ...
    <div class="zona-accidente">
        ...
        <h4>Cumplimiento Medidas</h4>                    
            ...
            <tbody><tr class="data-row"><td>                
                <?php echo $xml->ZONA_S->cumplimiento_medidas->fecha_verificacion?>
            </td></tr>
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>                        
                        <?php echo $xml->ZONA_S->cumplimiento_medidas->verificador->nombres?>
                    </td><td>                        
                        <?php echo $xml->ZONA_S->cumplimiento_medidas->verificador->apellido_paterno?>
                    </td><td>                          
                        <?php echo $xml->ZONA_S->cumplimiento_medidas->verificador->apellido_materno?>
                    </td><td>
                        <?php echo $xml->ZONA_S->cumplimiento_medidas->verificador->rut?>
