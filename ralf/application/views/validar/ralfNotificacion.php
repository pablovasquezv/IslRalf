...
<div id="container">
    ...
    <div class="zona zona-accidente">
        ...
        <table>
            <tbody>
                <tr class="data-row">
                    <td><?php echo $config_ralf['147']['causa_notificacion'][(int) $xml->ZONA_NOTIFICACION_RALF->causa_notificacion]; ?></td>
                </tr>
                <tr class="label-row">
        ...
        <?php $res = ORM::factory('Ralf147Notificaciones')->where('xml_id','=',$xml_id)->find_all(); ?>
        ...
        <?php $multas = ORM::factory('Ralf147Multas')->where('xml_id','=',$xml_id)->find_all(); ?>
        ...
        <table>
            <tbody>
                <tr class="data-row">
                    <td><?php echo $xml->ZONA_NOTIFICACION_RALF->representante_oa->apellido_paterno; ?></td>
                    <td><?php echo $xml->ZONA_NOTIFICACION_RALF->representante_oa->apellido_materno; ?></td>
                    <td><?php echo $xml->ZONA_NOTIFICACION_RALF->representante_oa->nombres; ?></td>
                    <td><?php echo $xml->ZONA_NOTIFICACION_RALF->representante_oa->rut; ?></td>
                </tr>
                <tr class="label-row">
            ...
            <tbody>
                <?php foreach ($anexos as $anexo): ?>
                    <tr class="data-row">
                        ...
                        <td><a href="<?php echo Kohana::$config->load('sitio.url_base'). $anexo->ruta; ?>" target="_blank">Ver</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
