...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var w = document.defaultView || document.parentWindow;
  		...
  		var l = d.getElementById('medida2');
  		<?php if(isset($_POST)):?>
		$(l).find('tbody').remove();
		$(l).append(get_medidas2());
		<?php endif;?>


		function get_medidas2(){
			$t = $("<tbody></tbody>");
			$.get('<?php echo URL::site("medidas/resultado_medidas_no_implementadas_plazo_ampliado/$xml_id");?>', function(data) {
...
<div class="popup-container">
  <h2><?php echo __('Medidas no implementadas que tuvieron ampliación de plazo'); ?></h2>
