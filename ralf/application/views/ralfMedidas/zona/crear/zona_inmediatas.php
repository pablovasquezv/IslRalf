                ...
                <tbody>                    
                    <?php foreach ($medidas as $m):?>    
                        <tr class="data-row">                            
                            ...
                            <td>
                            <?php echo HTML::anchor("ralfMedidas/borrar_medida/{$m->id}",'borrar',array('class'=>'fancybox-small'))?>
                            </td>
                        </tr>                    
                    <?php endforeach;?>
                </tbody></table>
                ...
                <?php foreach ($anexos as $anexo):?>    
                    <tr class="data-row">                        
                        ...
                        <td>
                            ...
                            <?php if($documento->ESTADO == 5): ?> | <?php echo HTML::anchor("ralfMedidas/borrar_adjunto/{$anexo->id}",'borrar',array('class'=>'fancybox-small'))?> <?php endif; ?>
                        </td>                        
                    </tr>                
                <?php endforeach;?>
            </tbody>
