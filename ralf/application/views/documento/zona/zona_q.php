    ...
    <div class='form_section accident'>
        ...
        <div class='row'>            
            <div class='field codigo_area'>
                ...
                <div class='protected_field'>
                    <?php
                        if(isset($xml->ZONA_Q)){
                            echo $xml->ZONA_Q->medidas_inmediatas->fecha_notificacion_medidas_inmediatas; 
                        }else{
                            echo $xml->ZONA_INMEDIATAS->fecha_notificacion_medidas_inmediatas; 
                        }
                    ?>
                </div>                
            </div>
      ...
      <!--  <div class='clear'></div> -->       
        ...
        <div class="row">
            ...
            <div class="field nombres">
                ...
                <div class='protected_field nombres'>
                    <?php 
                        if(isset($xml->ZONA_Q)){
                            echo $xml->ZONA_Q->medidas_inmediatas->investigador->nombres;
                        }else{
                            echo $xml->ZONA_INMEDIATAS->investigador->nombres;
                        }
                    ?>
                </div>
            </div>
            ...
            <div class='protected_field apellido_paterno'>
                <?php 
                    if(isset($xml->ZONA_Q)){
                        echo $xml->ZONA_Q->medidas_inmediatas->investigador->apellido_paterno; 
                    }else{
                        echo $xml->ZONA_INMEDIATAS->investigador->apellido_paterno; 
                    }
                ?>
            </div>                                
            </div>
            ...
            <div class='protected_field apellido_materno'>
                <?php 
                    if(isset($xml->ZONA_Q)){
                        echo $xml->ZONA_Q->medidas_inmediatas->investigador->apellido_materno; 
                    }else{
                        echo $xml->ZONA_INMEDIATAS->investigador->apellido_materno;
                    }
                ?>
            </div>                                
            </div>
            ...
            <div class='protected_field rut'>
                <?php 
                    if($xml->ZONA_Q){
                        echo $xml->ZONA_Q->medidas_inmediatas->investigador->rut; 
                    }else{
                        echo $xml->ZONA_INMEDIATAS->investigador->rut; 
                    }
                ?>
            </div>
            </div>                            
            <div class="clear"></div>
            <?php if(isset($xml->ZONA_Q->medidas_inmediatas->telefono_investigador)):?>
            <div class="telephone">
                <div class="field codigo_area"><label for="complaint_diat_attributes_employer_attributes_telephone_attributes_codigo_area">Código area</label><br>                    
                    <div class='protected_field'><?php echo $xml->ZONA_Q->medidas_inmediatas->telefono_investigador->cod_area; ?></div>                    
                </div>
                <div class="field numero"><label for="complaint_diat_attributes_employer_attributes_telephone_attributes_numero">Número de Teléfono</label><br>
                    <div class='protected_field'><?php echo $xml->ZONA_Q->medidas_inmediatas->telefono_investigador->numero; ?></div>                                        
                </div>
            </div>
            <?php endif?>
