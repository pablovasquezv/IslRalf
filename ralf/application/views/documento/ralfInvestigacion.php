...
?>
<div id="container">
    <div id="header"><h1>Informe del Accidente (investigación y medidas correctivas) (RALF Investigación)</h1></div>
    ...
    <div class="zona zona-accidente">
        ...
        <table><tbody>
                <tr class="data-row">                    
                    ...
                    <td>
                        <?php   $caso_id= $xml->ZONA_A->documento->codigo_caso;
                                $casoEncontrado = ORM::factory('Caso')->where('CASO_ID', '=', $caso_id)->find();
                        ?>
                        <?php if(isset($casoEncontrado->ORIGEN_COMUN)):?>
                            <?php echo $casoEncontrado->ORIGEN_COMUN;?>
                        <?php endif?>                    
                    </td>
                </tr>
                <tr class="label-row">                    
        ...
        <table>
            <tbody>
                    <tr class="data-row">                    
                        <td><?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->justificacion_no_laboral?></td>
                    </tr>
                    <tr class="label-row">                    
                        <th>Justificación Origen del Accidente</th>
                    </tr>
            </tbody>
        </table>
    ...
    <div class="zona-accidente">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->fecha_inicio_investigacion_acc;?>
                    </td>
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->fecha_termino_investigacion_acc;?>                
                    </td>
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->hora_ingreso;?>                        
                    </td>
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->hora_salida;?>                        
                    </td>
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row"><td>
                        ...
                        <?php echo $jornada_momento_accidente[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->jornada_momento_accidente];?>                        
            ...
            <table>
            <tbody><tr class="data-row"><td>
                <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->jornada_momento_accidente_otro)):?>
                    <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->jornada_momento_accidente_otro;?>                
                <?php endif?>
                </td></tr>
            ...
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->antiguedad->annos;?> (Años)                        
                    </td><td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->antiguedad->meses;?> (Meses)       
                    </td><td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->antiguedad->dias;?> (Dias)                               
                    </td>
                </tr>
                <tr class="label-row">                    
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->trabajo_habitual_cual;?>
                    </td>
                    <td>
                        <?php echo $si_no[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->trabajo_habitual];?>
                    </td>                   
                    <td align="center">
                        <?php $lugar_trabajo=array(1=>'Casa Matriz',2=>'Sucursal Empresa')?>                          
                        <?php echo $lugar_trabajo[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->lugar_trabajo];?>                                            
                    </td>
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>                        
                        <?php echo $si_no_nc[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->exist_comites_lugar_acc]?>                        
                    </td>
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->nro_comites_funcio?>
                    </td>
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->nro_comites_ds54_a1?>
                        
                    </td>
                    <td>
                        <?php echo $si_no[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->cumb_ob_info_ds40_a21];?>
                    </td>
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $si_no[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->reg_ohys_al_dia];?>
                    </td>
                    <td>
                        <?php echo $si_no[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->depto_pre_rie_teorico];?>
                    </td>
                    <td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->depto_pre_rie_real)):?>
                            <?php echo $si_no[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->depto_pre_rie_real];?>                        
                        <?php endif?>
                    </td>
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->exp_pre_em)):?>
                            <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->exp_pre_em->nombres;?>                        
                        <?php endif?>
                    </td><td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->exp_pre_em)):?>
                            <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->exp_pre_em->apellido_paterno;?>                        
                        <?php endif?>
                    </td><td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->exp_pre_em)):?>
                            <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->exp_pre_em->apellido_materno;?>                        
                        <?php endif?>
                    </td><td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->exp_pre_em)):?>
                            <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->exp_pre_em->rut;?>                        
                        <?php endif?>
                    </td>                    
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row">                    
                    <td>
                        ...
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->tipo_cont_exp_pre_em)):?>
                            <?php echo $tipo_cont_exp_pre_em[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->tipo_cont_exp_pre_em];?>     
                        <?php endif?>                            
                    <td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->tipo_cont_exp_pre_em_otro)):?>
                            <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->tipo_cont_exp_pre_em_otro;?>    
                        <?php endif?>
                    </td>
                </tr>
                <tr class="label-row">                    
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->nro_dias_jor_parcial_cont_exp_pre_emp)):?>
                            <?php echo $STDiasJornadaParcial[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->nro_dias_jor_parcial_cont_exp_pre_emp];?>
                        <?php endif?>

                    </td>
                    <td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->nro_reg_a_s_exp_pre_em)):?>
                            <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->nro_reg_a_s_exp_pre_em;?>                                                
                        <?php endif?>
                    </td>
                    <td>                        
                        <?php $cat_exp_pre_em=array(1=>'Profesional',2=>'Tecnico',3=>'Practico')?>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->cat_exp_pre_em)):?>
                            <?php echo $cat_exp_pre_em[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->cat_exp_pre_em];?>
                        <?php endif?>
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $si_no[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->programa_pre_rie];?>                        
                    </td>
                    <td>
                        <?php echo $si_no_nc[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->trabajador_reg_subcontratacion];?>
                        
                    </td>
                    <td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->registro_ac_antec_a66bis)):?>
                            <?php echo $si_no_nc[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->registro_ac_antec_a66bis];?>                        
                        <?php endif?>                        
                    </td>
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $si_no_nc[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->comite_par_fae_emp_ppal];?>                        
                    </td>
                    <td>
                        <?php echo $si_no_nc[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->depto_pre_rie_emp_ppal];?>
                    </td>
                    <td>
                        <?php echo $si_no_nc[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->imp_sist_gest_sst_emp_ppal];?>                        
                    </td>
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $si_no_nc[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->fiscalizacion_con_multas_mat_sst];?>
                    </td>
                    <td>
                        <?php $organismo_multas=array(1=>'DIRECCION DEL TRABAJO',2=>'SEREMI DE SALUD')?>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->organismo_multas)):?>
                            <?php echo $organismo_multas[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->organismo_multas];?>
                        <?php endif?>
                    </td>
                </tr>
                <tr class="label-row">
        ...
        <table>
            <tbody><tr class="data-row"><td>
                <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->desc_acc_invest;?>
            </td></tr>
                <tr class="label-row"><th>Descripción de como ocurrio el accidente</th></tr>
            </tbody></table>
        <table>
            <tbody><tr class="data-row"><td>
                <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->circunstancias_accidente;?>
            </td></tr>
                <tr class="label-row"><th>Circunstancia o contexto en el cual ocurrió el accidente</th></tr>
            </tbody>
        </table>
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php $vehiculo_involucrado=array(1=>'SI',2=>'NO')?>
                        <?php echo $vehiculo_involucrado[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->vehiculo_involucrado];?>
                    </td>
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->codificacion_vehiculo_involucrado->codigo_modo_transporte;?>
                    </td>
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->codificacion_vehiculo_involucrado->codigo_papel_lesionado;?>
                    </td>                                    
                </tr>
                <tr class="label-row">
...
?></th>                
            ...
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->codificacion_vehiculo_involucrado->codigo_contraparte;?>                        
                    </td>  
                    <td>
                       <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->codificacion_vehiculo_involucrado->codigo_tipo_evento)):?>
                            <?php $codigo_tipo_evento = (int) $xml->ZONA_INVESTIGACION->investigacion_acc->codificacion_vehiculo_involucrado->codigo_tipo_evento;?>                        
...
?></th>                  
            ...
            <table>
            <tbody><tr class="data-row"><td>
                <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->antecedentes_informacion_acc;?>                 
                </td></tr>
          ...
          <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->investigador_acc->nombres;?>
                        
                    </td><td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->investigador_acc->apellido_paterno;?>                        
                    </td><td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->investigador_acc->apellido_materno;?>                        
                    </td><td>
                        <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->investigador_acc->rut;?>                                                
                    </td>                    
                </tr>
        ...
        <table>
            <tbody><tr class="data-row"><td>
                <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->prof_invest_acc;?>                 
                </td></tr>
        ...
        <table>
            <tbody><tr class="data-row">
                    <td>
                        <?php echo $si_no[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->invest_es_experto];?>
                    </td>
                    <td>
                        <?php $categoria_experto=array(1=>'Profesional',2=>'Tecnico',3=>'Practico')?>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->categoria_experto)):?>
                            <?php echo $categoria_experto[(string)$xml->ZONA_INVESTIGACION->investigacion_acc->categoria_experto];?>
                        <?php endif?>
                    </td>
                    <td>
                        <?php if(isset($xml->ZONA_INVESTIGACION->investigacion_acc->nro_reg_a_s_invest_acc)):?>
                            <?php echo $xml->ZONA_INVESTIGACION->investigacion_acc->nro_reg_a_s_invest_acc;?>                        
                        <?php endif?>
                    </td>
                </tr>
                <tr class="label-row">
