...
class Controller_RalfAccidente extends Controller_Website {
    ...
    public function action_insertar() {
        ...
        $ralf_anterior=$caso->xmls->where('TPXML_ID','=', 141)->where('ESTADO','!=', 3)->find();
        ...
        $xmlstring->save();
        $this->redirect("ralfAccidente/crear/$xml_insert->XML_ID");
    }
    ...
    public function action_crear() {
        ...
        if (isset($_POST) AND Valid::not_empty($_POST)) {
            if(isset ($_POST['boton_finalizar'])) {                       
                $post = Validation::factory($_POST)
                        ...
                        ->rule('correo_electronico_informante_oa', 'email')
                        ;
	    ...
	    <rut_representante_legal></rut_representante_legal>
            ...
            <promedio_anual_trabajadores></promedio_anual_trabajadores>
                    ...
                    $xml_b->empleador->rut_representante_legal=$post['rut_representante_legal'];                    
                   ...
                   $ralf = simplexml_load_string($variable);                      
                    ...
                    if($valido['estado']) {
                        ...
                        $ralf1->rut_representante_legal=$post['rut_representante_legal'];
                ...
                $ralf->ZONA_B->empleador->rut_representante_legal=$post['rut_representante_legal'];  
        ...
        $this->template->contenido = $this->template->contenido = View::factory('ralfAccidente/crear')                 
                ->set('data', $data)
    ...
    public function values_default($ralf,$post) {
        ...
        if(empty($post)) {          
            ...
            $default['rut_representante_legal']=$ralf->ZONA_B->empleador->rut_representante_legal;
            ...
            $default['rut_representante_legal']=$post['rut_representante_legal'];                    
